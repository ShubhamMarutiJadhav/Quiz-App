    ...
    return (
        ...
        <div className='w-[40%] border shadow-lg rounded-md overflow-hidden'>
            ...
            <div className='flex justify-between'>
                <div className='cursor-pointer h-[30px] px-3 bg-green-500 text-black' onClick={saveHandler}>Save & Next</div>
                <div className='cursor-pointer h-[30px] px-3 bg-red-500 text-black' onClick={() => setExit(true)}>Exit</div>
            </div>
        </div>
